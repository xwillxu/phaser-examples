...
function create() {
    ...
    this.matter.add.image(830, 750, 'box');
    this.matter.add.image(830, 650, 'box');
    this.matter.add.image(830, 550, 'box');
    this.matter.add.image(730, 750, 'box');
    this.matter.add.image(730, 650, 'box');
    this.matter.add.image(730, 550, 'box');
    this.matter.add.image(630, 750, 'box');
    this.matter.add.image(630, 650, 'box');
    this.matter.add.image(630, 550, 'box');
    this.matter.add.image(530, 750, 'box');
    this.matter.add.image(530, 650, 'box');
    this.matter.add.image(530, 550, 'box');
    this.matter.add.image(430, 750, 'box');
    this.matter.add.image(430, 650, 'box');
    this.matter.add.image(430, 550, 'box');

    this.matter.add.image(830, 450, 'box');
    this.matter.add.image(830, 350, 'box');
    this.matter.add.image(830, 250, 'box');
    this.matter.add.image(730, 450, 'box');
    this.matter.add.image(730, 350, 'box');
    this.matter.add.image(730, 250, 'box');
    this.matter.add.image(630, 450, 'box');
    this.matter.add.image(630, 350, 'box');
    this.matter.add.image(630, 250, 'box');
    this.matter.add.image(530, 450, 'box');
    this.matter.add.image(530, 350, 'box');
    this.matter.add.image(530, 250, 'box');
    this.matter.add.image(430, 450, 'box');
    this.matter.add.image(430, 350, 'box');
    this.matter.add.image(430, 250, 'box');

    this.matter.add.image(830, 1050, 'box');
    this.matter.add.image(830, 950, 'box');
    this.matter.add.image(830, 850, 'box');
    this.matter.add.image(730, 1050, 'box');
    this.matter.add.image(730, 950, 'box');
    this.matter.add.image(730, 850, 'box');
    this.matter.add.image(630, 1050, 'box');
    this.matter.add.image(630, 950, 'box');
    this.matter.add.image(630, 850, 'box');
    this.matter.add.image(530, 1050, 'box');
    this.matter.add.image(530, 950, 'box');
    this.matter.add.image(530, 850, 'box');
    this.matter.add.image(430, 1050, 'box');
    this.matter.add.image(430, 950, 'box');
    this.matter.add.image(430, 850, 'box');
...
function updateText() {
    text.setText([
        ...
        'You can wall jump!',
        'Try to push all the boxes off the map!',
        'Do not die while pushing the boxes off the map',
